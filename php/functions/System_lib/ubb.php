...
$Text=preg_replace("/\[滑稽]/is","<img src='./assets/tb/1.png'>",$Text); 
$Text=preg_replace("/\[高兴]/is","<img src='./assets/tb/2.png'>",$Text); 
$Text=preg_replace("/\[阴险]/is","<img src='./assets/tb/0.png'>",$Text); 
$Text=preg_replace("/\[生气]/is","<img src='./assets/tb/3.png'>",$Text); 
$Text=preg_replace("/\[哭]/is","<img src='./assets/tb/4.png'>",$Text); 
$Text=preg_replace("/\[想哭]/is","<img src='./assets/tb/5.png'>",$Text); 
$Text=preg_replace("/\[图片\s(.+?)\](.+?)\[\/图片\]/is","<img \\1 src=\\2>",$Text); 
...
$Text=preg_replace("/\[居中\](.+?)\[\/居中\]/is","<center>\\1</center>",$Text); 
//$Text=preg_replace("/\[url=([^\[]*)\](.+?)\[\/url\]/is","<a href=\\1 target='_blank'>\\2</a>",$Text); 
$Text=preg_replace("/\[url\](.+?)\[\/url\]/is","<a href=\"\\1\" target='_blank'>\\1</a>",$Text); 
$Text=preg_replace("/\[url=(http:\/\/.+?)\](.+?)\[\/url\]/is","<a href='\\1' target='_blank'>\\2</a>",$Text); 
$Text=preg_replace("/\[url=(.+?)\](.+?)\[\/url\]/is","<a href=\\1>\\2</a>",$Text); 
$Text=preg_replace("/\[图片\](.+?)\[\/图片\]/is","$imgTB1<img src=\\1 data-am-pureviewed='1' alt='1'OnClick=\"window.open('\\1')\" style=\"cursor:pointer\"></p></div></li></ul>",$Text); 
$Text=preg_replace("/\[滑稽]/is","<img src='./assets/tb/1.png'>",$Text); 
$Text=preg_replace("/\[高兴]/is","<img src='./assets/tb/2.png'>",$Text); 
$Text=preg_replace("/\[生气]/is","<img src='./assets/tb/3.png'>",$Text); 
$Text=preg_replace("/\[阴险]/is","<img src='./assets/tb/0.png'>",$Text); 
...
$Text=preg_replace("/\[引用\](.+?)\[\/引用\]/is","<blockquote><div style='color:#393939;padding:5px' >\\1</div></blockquote>", $Text); 

        ...
        <form class="am-form am-form-horizontal" method="post" action="sendForum.php"> 
         <div class="am-form-group <?php echo $ArrayData[0][0];?>"> 
          ...
          <div class="am-u-sm-10"> 
           <input type="text" id="doc-ipt-3" name="title" placeholder="输入你的文章标题" /> 
          </div> 
         </div> 
          ...
          <div class="am-u-sm-10"> 
           <input type="text" id="doc-ipt-3" name="describtion" placeholder="输入你的文章标题" /> 
          </div> 
         </div> 
         <div class="am-form-group <?php echo $ArrayData[0][1];?>">
          ...
          <div class="am-u-sm-10"> 
           ...
           <textarea class="" rows="10" id="text" name="text"></textarea> 
          </div> 
         </div> 
